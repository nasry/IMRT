echo Starting linux application: HarvestControllerApplication_focused2
cd /home/test/IMRT
...
if [ -n "$PIDS" ] ; then
    ...
    java -Xmx1536m  -Ddk.netarkivet.settings.file=/home/test/IMRT/conf/settings_HarvestControllerApplication_focused2.xml -Dlogback.configurationFile=/home/test/IMRT/conf/logback_HarvestControllerApplication_focused2.xml dk.netarkivet.harvester.heritrix3.HarvestControllerApplication < /dev/null > start_HarvestControllerApplication_focused2.log 2>&1 &
fi
